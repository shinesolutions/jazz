...
function WhenStmt(expr, suite, orelse) {
    this.type = "jazz.ast.WhenStmt";
    this.expr = expr;
    this.suite = suite;
    this.orelse = orelse;
	return this;
...
WhenStmt.prototype.toString = function() {
	return "When(" + this.expr.toString() + ", " + this.suite.toString() + ", " + (this.orelse ? this.orelse.toString() : "null") + ")";
}
